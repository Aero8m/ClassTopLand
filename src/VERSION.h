...
#define FILE_VERSION           0,0,1,999
#define FILE_VERSION_STR       "Build |BUILD_VERSION|"
#define APP_VERSION            "|BUILD_VERSION|"
#define PRODUCT_VERSION        0,0,1,999
#define PRODUCT_VERSION_STR    "Build |BUILD_VERSION|"
